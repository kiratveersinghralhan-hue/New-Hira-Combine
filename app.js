...
function storageRead(area, key, fallback = '') {
  try {
...
function storageRemove(area, key) {
  try {
    ...
    // The in-memory state still keeps the current visit functional.
  }
}

let currentLanguage = storageRead('localStorage', LANGUAGE_KEY, 'en');
...
const TRANSLATIONS = {
  en: {
    ...
    twinEyebrow: 'INTERACTIVE MACHINE THEATRE', twinTitle: 'See the machine.<br /><em>Read the field.</em>', twinCopy: 'Explore the exact New Hira product cutouts inside a live three-dimensional field system. Drag the stage, switch models and compare the brochure figures before you reserve.',
    twinRequest: 'Share the field', twinRequestCopy: 'Crop, acreage, village and preferred date.', twinMatch: 'Match the machine', twinMatchCopy: 'The desk checks access, timing and machine fit.', twinConfirm: 'Confirm the window', twinConfirmCopy: 'Reference-backed follow-up by phone or WhatsApp.', twinBook: 'Start a field request', twinWhatsApp: 'WhatsApp booking desk', twinDrag: 'DRAG / TOUCH TO MOVE THE FIELD',
  ...
  hi: {
    ...
    twinEyebrow: 'इंटरैक्टिव मशीन थिएटर', twinTitle: 'मशीन देखें।<br /><em>खेत को समझें।</em>', twinCopy: 'सटीक न्यू हीरा प्रोडक्ट कटआउट को लाइव 3D फील्ड सिस्टम में देखें। स्टेज ड्रैग करें, मॉडल बदलें और बुकिंग से पहले ब्रॉशर आँकड़ों की तुलना करें।', twinRequest: 'खेत की जानकारी दें', twinRequestCopy: 'फसल, एकड़, गाँव और पसंदीदा तारीख।', twinMatch: 'मशीन का मिलान', twinMatchCopy: 'डेस्क पहुँच, समय और मशीन की उपयुक्तता जाँचता है।', twinConfirm: 'समय की पुष्टि', twinConfirmCopy: 'रेफरेंस के साथ फोन या WhatsApp पर फॉलो-अप।', twinBook: 'फील्ड अनुरोध शुरू करें', twinWhatsApp: 'WhatsApp बुकिंग डेस्क', twinDrag: 'फील्ड घुमाने के लिए ड्रैग / टच करें',
  ...
  pa: {
    ...
    twinEyebrow: 'ਇੰਟਰਐਕਟਿਵ ਮਸ਼ੀਨ ਥੀਏਟਰ', twinTitle: 'ਮਸ਼ੀਨ ਵੇਖੋ।<br /><em>ਖੇਤ ਨੂੰ ਸਮਝੋ।</em>', twinCopy: 'ਸਹੀ ਨਿਊ ਹੀਰਾ ਪ੍ਰੋਡਕਟ ਕਟਆਉਟ ਨੂੰ ਲਾਈਵ 3D ਫੀਲਡ ਸਿਸਟਮ ਵਿੱਚ ਵੇਖੋ। ਸਟੇਜ ਡਰੈਗ ਕਰੋ, ਮਾਡਲ ਬਦਲੋ ਅਤੇ ਬੁਕਿੰਗ ਤੋਂ ਪਹਿਲਾਂ ਬਰੋਸ਼ਰ ਅੰਕੜੇ ਮਿਲਾਓ।', twinRequest: 'ਖੇਤ ਦੀ ਜਾਣਕਾਰੀ ਦਿਓ', twinRequestCopy: 'ਫਸਲ, ਏਕੜ, ਪਿੰਡ ਅਤੇ ਪਸੰਦੀਦਾ ਤਾਰੀਖ।', twinMatch: 'ਮਸ਼ੀਨ ਮਿਲਾਓ', twinMatchCopy: 'ਡੈਸਕ ਰਸਤਾ, ਸਮਾਂ ਅਤੇ ਮਸ਼ੀਨ ਦੀ ਢੁਕਵੀਂ ਚੋਣ ਜਾਂਚਦਾ ਹੈ।', twinConfirm: 'ਸਮਾਂ ਪੱਕਾ ਕਰੋ', twinConfirmCopy: 'ਰੈਫਰੈਂਸ ਨਾਲ ਫੋਨ ਜਾਂ WhatsApp ਉੱਤੇ ਫਾਲੋ-ਅੱਪ।', twinBook: 'ਫੀਲਡ ਬੇਨਤੀ ਸ਼ੁਰੂ ਕਰੋ', twinWhatsApp: 'WhatsApp ਬੁਕਿੰਗ ਡੈਸਕ', twinDrag: 'ਫੀਲਡ ਘੁਮਾਉਣ ਲਈ ਡਰੈਗ / ਟਚ ਕਰੋ',
...
const MODELS = {
  '985': {
    name: '985',
    image: 'cutout-985-three-quarter.png',
    ...
    tank: '1,800',
    walkers: '5',
    brochure: 'brochure-985-specs.jpg',
    specs: [
  ...
  '785': {
    name: '785',
    image: 'cutout-785-brochure-model.png',
    ...
    tank: '1,600',
    walkers: '4',
    brochure: 'brochure-785-specs.jpg',
    specs: [
...
function applyLanguage(language, track = false) {
  ...
  storageWrite('localStorage', LANGUAGE_KEY, next);
...
const adminState = {
  token: storageRead('sessionStorage', ADMIN_TOKEN_KEY),
  bookings: [],
  leads: [],
  media: [],
  page: 1,
...
function setupOnboarding() {
  ...
  const completeExperience = () => {
    ...
    window.setTimeout(() => {
      ...
      document.body.classList.add('is-ready');
      storageWrite('sessionStorage', ONBOARDING_KEY, String(Date.now()));
      document.dispatchEvent(new Event('newhira:ready'));
  ...
  const closeLead = (reason) => {
    storageWrite('localStorage', LEAD_GATE_KEY, String(Date.now()));
...
function savePendingBooking(booking) {
  const current = JSON.parse(storageRead('localStorage', PENDING_BOOKINGS_KEY, '[]'));
  current.unshift(booking);
  storageWrite('localStorage', PENDING_BOOKINGS_KEY, JSON.stringify(current.slice(0, 20)));
}
...
function setupLeadGate() {
  ...
  const lastSeen = Number(storageRead('localStorage', LEAD_GATE_KEY, '0'));
...
async function loginDesk(event) {
  ...
  try {
    ...
    storageWrite('sessionStorage', ADMIN_TOKEN_KEY, response.token);
    form.reset();
    await enterDesk();
